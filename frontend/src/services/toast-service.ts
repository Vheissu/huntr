...
export const IToastService = DI.createInterface<IToastService>('IToastService', x => x.singleton(ToastService));

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface IToastService extends ToastService {}
