...
class Accounts implements AccountsInterface {
	...
	public function register() {
		...
		if ( $mj_util->mo_jwt_is_customer_registered() ) {
	...
	public function show_customer_info() {
		...
		<div class="mo_table_layout" >
			...
			<tr>
				...
				<td style="width:55%; padding: 10px;"><?php echo wp_kses( $mj_util->mo_jwt_get_option( 'mo_jwt_admin_email' ), \mo_jwt_get_valid_html() ); ?></td>
			</tr>
			<tr>
				<td style="width:45%; padding: 10px;">Customer ID</td>
				<td style="width:55%; padding: 10px;"><?php echo wp_kses( $mj_util->mo_jwt_get_option( 'mo_jwt_admin_customer_key' ), \mo_jwt_get_valid_html() ); ?></td>
			</tr>
			</table>
			<br /><br />
